export const localData = {
  ...
  projects: [
    ...
    // --- MOBILE SOFTWARE ---
    {
      ...
      problem: "Need for seamless, low-latency PC peripheral control from mobile devices over Wi-Fi without proprietary dongles.",
      ...
      bullets: [
        "Low-latency Wi-Fi socket protocol enabling real-time PC mouse and touchpad navigation.",
        "Virtual keyboard, custom macro shortcuts, and multi-media controller integration.",
        "Published and distributed as a paid mobile application on AppHub."
      ],
      techStack: [
        "Android",
        "Java / Kotlin",
