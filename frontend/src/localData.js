export const localData = {
  ...
  contact: {
    ...
    phone: "7068604832",
    location: "Lucknow, U.P. 226015",
    github: "https://github.com/nomaantalib",
    linkedin: "https://linkedin.com/in/mohd-nomaan-talib-256b93276",
    ...
    ibmCertificate: "https://drive.google.com/file/d/16dzCcULMzphcaM6OiF0FUFN4WHfnV322/view?usp=drivesdk"
  },
  ...
  coreCompetencies: [
    ...
    {
      title: "User Research & A/B Experimentation",
  ...
  experience: [
    {
      title: "Software Engineer — AI Agents Testing & Backend Development (Contract)",
      company: "Turing",
      companyLink: "https://www.turing.com/",
      duration: "Aug 2026 – Present",
      isCurrent: true,
      description: "Driving engineering quality, algorithmic rigor, and synthetic SaaS backend replication for enterprise AI agent benchmarking systems.",
      details: [
        "Review and refine LLM-generated problem statements for clarity and rigor, ensuring adherence to strict Codeforces-style standards, including LaTeX formatting and deterministic outputs.",
        "Validate the correctness of brute-force and optimal algorithmic solutions, ensuring code is efficient, readable, and adheres to language-specific style guides.",
        "Develop and review multi-step Chain-of-Thought (CoT) reasoning chains exploring naive-to-optimal approaches, articulating the rationale behind data structure and algorithm choices.",
        "Generate automated test suites (30+ cases per task) and validate solutions in Docker-based testing environments, alongside plagiarism checks against platforms such as AtCoder and CodeChef.",
        "Build Python backend applications that replicate existing SaaS tools (Slack, Linear, Jira, Notion, Gmail, wikis) as part of Turing's Connectors / ComputerBench initiative, implementing integrations and full-service backend functionality."
      ],
      skills: ["AI Agents Testing", "Chain-of-Thought (CoT)", "Docker", "Python", "Codeforces Standards", "SaaS Backend Replication"]
    },
    {
  ...
  projects: [
    ...
    },
    {
      ...
      category: "ai",
      categoryLabel: "Product Case Study",
      metric: "Significant Cut in Audit Review Time",
    ...
    },
    {
      ...
      problem: "Solved sales-prioritization inefficiency by defining a product using AI-driven lead scoring and a pipeline dashboard. Achieved reduced manual triage effort for sales teams, improving focus on high-value leads.",
    ...
    {
      title: "Sentinel AI — AI-Powered Security Threat & Anomaly Detection",
      category: "ai",
      categoryLabel: "Security & AI",
      metric: "Real-time Threat Monitoring Platform",
      problem: "Solved delayed threat detection in web infrastructure by creating an automated security platform that flags anomalous access patterns in real-time.",
    ...
    {
      title: "SmartKeyboard APP — Wireless Remote PC Control Application",
      category: "app",
      categoryLabel: "Mobile Software",
      metric: "Paid Android App on AppHub",
      problem: "Solved the need for seamless, low-latency PC peripheral control from mobile devices over Wi-Fi without proprietary dongles.",
